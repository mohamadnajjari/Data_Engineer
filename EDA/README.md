...
1. [`1_top_demanded_skills.sql`](1_top_demanded_skills.sql) – demand analysis with multi-table joins  
2. [`2_top_paying_skills.sql`](2_top_paying_skills.sql) – salary analysis with aggregations  
3. [`3_optimal_skills.sql`](3_optimal_skills.sql) – combined demand/salary optimization query  
...
├── 1_top_demanded_skills.sql    # Demand analysis query
├── 2_top_paying_skills.sql      # Salary analysis query
├── 3_optimal_skills.sql         # Combined demand/salary optimization
...
1. **[Top Demanded Skills](1_top_demanded_skills.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
